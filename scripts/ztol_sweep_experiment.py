...
ALPHA = 0.1
MODEL_DIR = ROOT / "models" / "ztol_sweep_inelastic"
RESULTS_PATH = ROOT / "results" / "ztol_sweep_inelastic" / "ztol_sweep_inelastic_results.json"
POSE_PLOT_PATH = ROOT / "results" / "ztol_sweep_inelastic" / "ztol_pose_inelastic_comparison.png"
...
def model_path(z_tol):
    return MODEL_DIR / f"ppo_latto_inelastic_ztol_{ztol_tag(z_tol)}"

...
ALPHA = 0.1
Z_TOL = 0.08
MODEL_PREFIX = "ppo_latto_inelastic_wc"
RESULTS_JSON = "collision_reward_sweep_inelastic_results.json"
POSE_PLOT = "collision_reward_pose_inelastic_comparison.png"
...
def model_path(weight):
    return f"{MODEL_PREFIX}_{reward_weight_tag(weight)}"
